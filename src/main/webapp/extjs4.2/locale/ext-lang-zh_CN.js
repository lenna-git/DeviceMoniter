 ...
 * @param {} strText
 */
function sysGridSort(strText) 
{
	var strGridBbar='<font size=4>'+strText+'</font>';
	return strGridBbar;
}
Ext.define("Ext.locale.zh_CN.grid.header.Container", {
    override: "Ext.grid.header.Container",
    sortAscText: sysGridSort("正序"),
    //update
    sortDescText: sysGridSort("倒序"),
    //update
    lockText: sysGridSort("锁定列"),
    //update
    unlockText: sysGridSort("解除锁定"),
    //update
    columnsText: sysGridSort("列")
});
